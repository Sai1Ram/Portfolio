  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `url('https://res.cloudinary.com/dtp5uqey3/image/upload/v1690180218/portfolio/herobg_wrymsp.png')`,
      ...
      >
        ...
        <SideBar rotate={"rotate-[-90deg]"} side={"left"} text={"Works"} />
        ...
        >
          <div className="flex flex-col items-center ">
            ...
            <h1 className="text-gray-500 md:text-4xl text-lg lg:text-5xl">
              <AnimatedTextCharacter
                text={"Hi, I'm Sai Ram Senapati from India"}
                name={true}
              />
            </h1>
            <h1 className="text-gray-500 text-md md:text-2xl lg:text-4xl">
              <AnimatedTextCharacter
        ...
        <SideBar rotate={"rotate-[90deg]"} side={"right"} text={"Profile"} />
      </div>
    </>
  );
}
